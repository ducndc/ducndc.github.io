import {
  insertCluster
} from "./chunk-AYR6TIVK.js";
import {
  insertEdge,
  insertEdgeLabel,
  markers_default,
  positionEdgeLabel
} from "./chunk-3JGYHIDS.js";
import {
  insertNode
} from "./chunk-4TGK3ZZC.js";
import {
  labelHelper
} from "./chunk-T2S3EFA4.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-GXQ25YYZ-RXEDUN2J.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-42K2YHIH-IQUPY47M.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-A3X2MYQN.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-CRSS4DNS.js.map
