...
tags: [vpn, ipsec, ssl, tunneling, security]
description: "Fundamentals of VPNs including site-to-site and remote access scenarios plus protocol comparisons."
toc: true
pin: true
---
...
VPN stands for Virtual Private Network, a technology that creates a safe, encrypted connection over a less secure network such as the internet. It acts as an extension of a private network and is used to share resources between organisations or to allow remote users to access corporate services as if they were on‑site.
...
VPNs enable secure, encrypted communication across untrusted networks, with a variety of protocols (IPsec, SSL/TLS, OpenVPN, etc.) suited to different use cases such as site‑to‑site or remote access. Proper selection of authentication, encryption, and key‑exchange methods ensures both security and performance.
