...
categories: [WiFi]
tags: [roaming, wifi, fast-roaming, pmk]
description: "Roaming mechanisms, fast roaming, and band steering concepts."
toc: true
pin: true
---
...
Smart roaming and fast-roaming techniques (PMK caching, 802.11r/k/v) significantly improve user experience in dense and mobile deployments when configured correctly.
</div>
