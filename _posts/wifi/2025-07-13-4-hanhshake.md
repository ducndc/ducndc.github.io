...
categories: [WiFi]
tags: [wpa, handshake, security, wpa2]
description: "Explains the 4‑way handshake, PTK/GTK derivation and common failure reasons."
toc: true
pin: true
---
...
The 4‑way handshake establishes encryption keys (PTK/GTK); understanding its messages and failure codes helps diagnose Wi‑Fi security issues.